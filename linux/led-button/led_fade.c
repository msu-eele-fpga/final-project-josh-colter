...
*/
static ssize_t led_button_reg_show(struct device *dev,
...
*/
static ssize_t led_button_reg_store(struct device *dev,
...
* value is returned.
*/
static ssize_t led_fade_read(struct file *file, char __user *buf,
...
* value is returned.
*/
static ssize_t led_fade_write(struct file *file, const char __user *buf,
size_t count, loff_t *offset)
{
size_t ret;
u32 val;
