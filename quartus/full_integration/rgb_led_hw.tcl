...
add_fileset_file rgb_led_avalon.vhd VHDL PATH ../../hdl/rgb_led_avalon/rgb_led_avalon.vhd TOP_LEVEL_FILE
...
# 
# connection point rgb_led
# 
add_interface rgb_led conduit end
set_interface_property rgb_led associatedClock clk
set_interface_property rgb_led associatedReset ""
set_interface_property rgb_led ENABLED true
set_interface_property rgb_led EXPORT_OF ""
set_interface_property rgb_led PORT_NAME_MAP ""
set_interface_property rgb_led CMSIS_SVD_VARIABLES ""
set_interface_property rgb_led SVD_ADDRESS_GROUP ""

add_interface_port rgb_led output1 output1 Output 1
add_interface_port rgb_led output2 output2 Output 1
add_interface_port rgb_led output3 output3 Output 1
